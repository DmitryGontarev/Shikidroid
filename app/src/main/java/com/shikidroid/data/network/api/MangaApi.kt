...
internal interface MangaApi {
     ...
     */
    @GET("/api/mangas/{id}")
    fun getMangaDetailsById(@Path("id") id : Long) : Single<MangaDetailsResponse>
    ...
    fun getMangaRolesById(@Path("id") id: Long): Single<List<RolesResponse>>
    ...
    fun getSimilarManga(@Path("id") id: Long): Single<List<MangaResponse>>
    ...
    fun getRelatedManga(@Path("id") id: Long): Single<List<RelatedResponse>>
    ...
    fun getMangaFranchise(@Path("id") id: Long): Single<FranchiseResponse>
    ...
    fun getMangaExternalLinksById(@Path("id") id: Long): Single<List<LinkResponse>>
}