...
import com.shikidroid.presentation.navigation.sealedscreens.tv.SearchTvScreens
...
import com.shikidroid.presentation.screens.tvmal.SearchTvMalScreen
...
/**
 * Граф навигации для экрана "Поиск" AndroidTV
 *
...
internal fun SearchTvMalGraph(
    ...
    NavHost(
        ...
        startDestination = SearchTvScreens.SearchTv.route
    ) {

        composable(route = SearchTvScreens.SearchTv.route) {
            ...
            SearchTvMalScreen(viewModel = viewModel, navigator = navController)
        }

        composable(route = SearchTvScreens.DetailsTv.route) {
        ...
        composable(route = SearchTvScreens.EpisodeTv.route) {
