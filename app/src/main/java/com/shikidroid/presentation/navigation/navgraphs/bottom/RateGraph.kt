...
import com.shikidroid.presentation.screens.RateScreen
...
/**
 * Граф навигации для экрана "Списки"
 *
...
internal fun RateGraph(
    ...
    NavHost(
        ...
        startDestination = RatesScreens.Rate.route
    ) {

        composable(route = RatesScreens.Rate.route) {
        ...
        composable(route = RatesScreens.Details.route) {
        ...
        composable(route = RatesScreens.CharacterPeople.route) {
        ...
        composable(route = RatesScreens.WebView.route) {
        ...
        composable(route = RatesScreens.Episode.route) {
        ...
        composable(route = RatesScreens.Search.route) {
