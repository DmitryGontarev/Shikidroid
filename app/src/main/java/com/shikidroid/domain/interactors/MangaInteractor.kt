...
/**
 * Интерфейс интерактора получения данных о манге
 */
internal interface MangaInteractor {
 ...
 *
 * @property mangaRepository репозиторий для получения данных о манге
 */
internal class MangaInteractorImpl @Inject constructor(
    ...
    override fun getMangaListByParameters(
        ...
        return mangaRepository.getMangaListByParameters(
            page = page,
            limit = limit,
            order = order,
            kind = kind,
